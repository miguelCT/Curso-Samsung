...
public class TextoTest {
	...
	@Before
	public void ini() {
		H = CaracterFactory.getFactoria().get('H');
		o = CaracterFactory.getFactoria().get('o');
		l = CaracterFactory.getFactoria().get('l');
		a = CaracterFactory.getFactoria().get('a');
		pf = new Parrafo();
		pf.add(H);
		pf.add(o);
		pf.add(l);
	...
	public void testCaracterFlyweight() {
		assertSame(H, CaracterFactory.getFactoria().get('H'));
	}
